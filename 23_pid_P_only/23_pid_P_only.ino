...
// Servo adjustment
#define _DUTY_MAX 2600  // Servo angle: D degree
...
// PID parameters
#define _KP 1.35 // proportional gain
...
{
  return 523 + -2.97*x + 6.33E-03*x*x + -4.9E-06*x*x*x; // Replace this with the equation obtained from nonlinear regression analysis
}
