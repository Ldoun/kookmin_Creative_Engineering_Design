...
{
  return 70.1 + -0.501*a_value + 1.31E-03*a_value*a_value + -1.17E-06*a_value*a_value*a_value; // Replace this with the equation obtained from nonlinear regression analysis
}
