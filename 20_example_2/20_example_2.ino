...
{
  return 52.3 + -0.297 * a_value + 6.33E-04 * a_value * a_value + -4.9E-07 * a_value * a_value * a_value; // Replace this with the equation obtained from nonlinear regression analysis
}
